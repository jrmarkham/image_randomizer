...
const Duration _animateFadeDuration = Duration(
  seconds: numbers.fadeDelayDurationSeconds,
);
const Duration _fadeDurationDelay = Duration(
  microseconds: numbers.fadeDelayDurationSeconds,
);

const Duration _animateColorDuration = Duration(
  seconds: numbers.colorDurationSeconds,
);
...
class _ColorTweenAnimationState extends State<ColorTweenAnimation>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration:_animateColorDuration,
    );
    _colorAnimation = ColorTween(
      begin: widget.colorStart,
      end: widget.colorFinish,
    ).animate(_controller);
    _controller.forward();
    super.initState();
  }
